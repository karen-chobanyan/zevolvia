...
export default function SupportMetrics({ total, pending, solved, loading }: SupportMetricsProps) {
  const formatValue = (value: number) => (loading ? "-" : numberFormatter.format(value));
