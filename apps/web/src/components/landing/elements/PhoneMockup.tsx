...
export function PhoneMockup({ messages, className, animated = true }: PhoneMockupProps) {
  return (
    <div className={cn("relative mx-auto w-[280px] sm:w-[320px]", className)}>
          ...
          <div className="relative h-full w-full overflow-hidden rounded-[55px] bg-gray-100 ring-[3px] ring-black">
            ...
            <div className="border-b border-gray-200 bg-gray-100 px-4 py-3 pt-2">
              <div className="flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-full bg-gradient-to-br from-purple-500 to-purple-700 shadow-sm">
                  <span className="text-sm font-bold text-white">KD</span>
                </div>
                <div>
                  <div className="text-sm font-semibold text-gray-900">KitchenDocs Assistant</div>
            ...
            <div className="border-t border-gray-200 bg-white p-3 pb-8">
              <div className="flex items-center gap-2">
                <div className="flex-1 rounded-full bg-gray-100 px-4 py-2.5 transition-colors hover:bg-gray-200/70">
                  <span className="text-sm text-gray-400">Text a question...</span>
                </div>
                <button className="flex h-9 w-9 items-center justify-center rounded-full bg-purple-600 shadow-md transition-transform hover:scale-105 active:scale-95">
                  <svg
      ...
      <div className="absolute -right-4 -top-4 -z-10 h-32 w-32 rounded-full bg-purple-400/30 blur-2xl" />
      <div className="absolute -bottom-6 -left-6 -z-10 h-32 w-32 rounded-full bg-purple-600/30 blur-2xl" />
    </div>
  );
}
