...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const load = async () => {
      try {
        const [me, dashboardSummary] = await Promise.all([
          getMe(),
          getDashboardSummary(),
        ]);
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-10">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-3xl font-semibold text-gray-900">SalonIQ Dashboard</h1>
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
          ...
          <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-theme-xs">
            ...
            <p className="mt-1 text-sm text-gray-500">
              Automated suggestions ready to review.
            </p>
